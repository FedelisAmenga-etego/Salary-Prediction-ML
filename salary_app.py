...
st.markdown(
    ...
    <div style="text-align: center; padding: 20px;">
        <h1 style="color: #2E86C1;">💼 Salary Prediction: ML</h1>
        <p style="font-size:18px; color:#555;">
            Enter your details below to get an estimate of your expected salary.
        </p>
    </div>
    """,
...
Age = st.sidebar.number_input("Age", min_value=18, max_value=70, value=25)
...
Years_Exp = st.sidebar.number_input("Years of Experience", min_value=0, max_value=50, value=3)
...
if st.sidebar.button("🚀 Predict Salary"):
    ...
    st.markdown(
        ...
        <div style="background-color:#D5F5E3;
                    ...
                    text-align:center;
                    margin-top:30px;">
            <h2 style="color:#1D8348;">Predicted Salary</h2>
            <h1 style="color:#117A65;">${salary:,.2f}</h1>
        </div>
        """,
        unsafe_allow_html=True
    )
